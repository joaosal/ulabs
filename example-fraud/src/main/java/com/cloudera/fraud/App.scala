package com.cloudera.fraud;

import com.cloudera.fraud.ml.{AnomalyDetection, FeaturesParser}
...
object MainRun {
  ...
  val rawFilePath = "hdfs:///user/hdfs/fraud/training.csv"
  val cvFilePath = "hdfs:///user/hdfs/fraud/cross_val.csv"

  def main(args: Array[String]) {

    val conf = new SparkConf().setAppName("Fraud Detection Spark")
